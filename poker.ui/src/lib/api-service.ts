...
export class ApiService {
  ...
  constructor(private ea: EventAggregator, private util: Util) {
    ...
    // console.log(process.env.POKER_API_DEV_PORT);
    // console.log(process.env.POKER_API_DEV_URL);
    // let port = environment.debug ? ':' + process.env.POKER_API_DEV_PORT : '';
    // let host = environment.debug ? process.env.POKER_API_DEV_URL : window.location.hostname;     
